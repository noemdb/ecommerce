      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b dark:border-neutral-800">
          <div className="flex items-center gap-2">
            ...
            <span className="bg-neutral-100 dark:bg-neutral-800 text-xs font-bold px-2 py-0.5 rounded-lg">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          {items.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-center space-y-6">
              <div className="w-20 h-20 bg-neutral-50 dark:bg-neutral-800 rounded-lg flex items-center justify-center text-neutral-300 dark:text-neutral-600">
              ...
              <button 
                onClick={toggleCart}
                className="px-8 py-3 bg-neutral-900 dark:bg-white text-white dark:text-neutral-900 rounded-lg font-bold shadow-lg active:scale-95 transition-all"
              >
                Explorar productos
              </button>
            </div>
        ...
        {items.length > 0 && (
          <div className="p-6 border-t dark:border-neutral-800 bg-neutral-50/50 dark:bg-neutral-900 shadow-[0_-4px_20px_-5px_rgba(0,0,0,0.05)]">
            ...
            <Link 
              href="/checkout" 
              onClick={toggleCart}
              className="w-full h-14 bg-blue-600 hover:bg-blue-700 text-white flex items-center justify-center gap-3 rounded-md font-bold transition-all shadow-xl shadow-blue-500/20 active:scale-[0.98] group"
            >
              Completar pedido
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </Link>
            <div className="flex items-center justify-center gap-2 mt-4 text-neutral-400">
              <div className="w-1 h-1 rounded-lg bg-neutral-300" />
