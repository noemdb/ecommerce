    ...
    return (
      <div className="w-full space-y-2">
        ...
        <div className="relative group">
          ...
          <div className="absolute inset-0 rounded-md opacity-0 group-focus-within:opacity-100 ring-2 ring-blue-600/5 pointer-events-none transition-opacity" />
        </div>
        {error && (
