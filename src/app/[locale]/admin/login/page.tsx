...
export default async function AdminLoginPage({
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-20 px-4 bg-neutral-900 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-blue-600/10 rounded-lg blur-[140px] -translate-y-1/2 translate-x-1/2" />
      <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-blue-900/10 rounded-lg blur-[120px] translate-y-1/2 -translate-x-1/2" />
