  ...
  return (
    <div className="flex flex-col gap-8 p-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {kpis.map((kpi, i) => (
          <div key={i} className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 p-6 rounded-md flex flex-col gap-4 shadow-sm hover:shadow-md transition-shadow">
            <div className={`w-12 h-12 ${kpi.bg} rounded-md flex items-center justify-center`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="p-2">
            {[
              ...
              <Link 
                key={i} 
                href={link.href}
                className="flex items-center justify-between p-4 hover:bg-neutral-50 dark:hover:bg-neutral-800/50 rounded-md transition-colors group"
              >
        ...
        <div className="bg-neutral-900 text-white rounded-md p-8 flex flex-col justify-between relative overflow-hidden shadow-xl shadow-blue-900/10">
          ...
          {/* Decorative element */}
          <div className="absolute top-0 right-0 w-64 h-64 bg-blue-600/20 blur-[80px] rounded-lg translate-x-1/2 -translate-y-1/2" />
        </div>
      </div>
    </div>
  );
